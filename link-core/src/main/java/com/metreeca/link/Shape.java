...
import com.metreeca.link.specs.Expression;
import com.metreeca.link.specs.Transform;
...
public abstract class Shape {
    ...
    public static final String ReverseScheme="reverse:";
    ...
    private static <T> Supplier<T> memoize(final Supplier<T> supplier) {
        ...
        return supplier instanceof Memo ? supplier : new Memo();
    }


    //// IRI Helpers ///////////////////////////////////////////////////////////////////////////////// !!! review/remove

    public static boolean direct(final String property) {
    ...
    public static String forward(final String property) {

        if ( property == null ) {
            throw new NullPointerException("null property");
        }

        return property.startsWith(ReverseScheme) ? property.substring(ReverseScheme.length()) : property;
    }
    ...
    public static String reverse(final String property) {
        ...
        return property.startsWith(ReverseScheme) ? property : ReverseScheme+property;
    }
    ...
    /**
     * @return {@code true} if the described resources is dynamically generated by the data storage engine, rather than
     * actually stored in the data backend (e.g. virtual resource collections); {@code false}, otherwise
     */
